...
.. raw:: html
   ...
   <p>TIGER 0.7.0 provides four generators, fourteen named datasets, and ten toy graphs. Names are case-sensitive. Print the installed version’s catalog rather than guessing a loader key:</p><pre><code>from graph_tiger.graphs import graph_loader, get_graph_options
