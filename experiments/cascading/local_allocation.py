"""Compare local sharing policies and draw the tutorial results.

Run python -m experiments.cascading.local_allocation --output-dir PATH.
"""
import os, csv, json, hashlib, tempfile, argparse
...
def main():
    ...
    parser.add_argument('--output-dir',type=Path,default=Path('local-allocation-results'))
    ...
    metadata={'implementation':'TIGER local allocation policies','policies':list(labels),
