...
base_url = 'https://github.com/safreita1/TIGER/tree/master/datasets/'
...
def download_dataset(dataset):
    ...
    """
    url_path = base_url + dataset + ".txt"
    local_path = graph_dir + '' + dataset + '.txt'
...
graph_urls = {
    ...
    'cit_hep_th': 'https://snap.stanford.edu/data/M.txt.gz',
